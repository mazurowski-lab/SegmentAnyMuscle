...
class MaskDecoder(nn.Module):
    ...
    def forward(
        ...
        """
        masks, iou_pred, moe_loss = self.predict_masks(
        ...
        # Prepare output
        return masks, iou_pred, moe_loss
    ...
    def predict_masks(
        ...
        # Run the transformer
        hs, src, moe_loss = self.transformer(src, pos_src, tokens, labels=labels, training=training)
        iou_token_out = hs[:, 0, :]
